                    ...
                    <Header :style="{position: 'fixed',
                        ...
                        box-shadow: 0 2px 1px 1px rgba(100, 100, 100, 0.1);">
                            ...
                            <div style="margin-right:20px">
                                ...
                                <Button type="text" icon="android-exit" size="large" @click="quit">返回</Button>
                            </div>
                        </div>
